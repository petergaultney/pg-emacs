...
(custom-set-faces
  ...
  '(outline-1 ((t (:inherit nil :foreground "cornflowerblue" :weight bold))))
  '(outline-2 ((t (:foreground "mediumseagreen" :weight bold))))
  '(outline-3 ((t (:foreground "gold" :weight bold))))
  '(outline-4 ((t (:foreground "coral"))))
  '(outline-5 ((t (:foreground "violet"))))
  '(outline-6 ((t (:foreground "slateblue"))))
